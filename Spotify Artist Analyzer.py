...
def plot_box_plot(tracks_df):
    ...
    for i, artist in enumerate(artists):
        ...
        #danceability
        fig.add_trace(go.Box(y=artist_features.danceability, name=artist, line={'color':colors[i]}, opacity=.5), row=1,col=1)
        #energy
        fig.add_trace(go.Box(y=artist_features.energy, name=artist, line={'color':colors[i]}, opacity=.5), row=1,col=2)
        #loudness
        fig.add_trace(go.Box(y=artist_features.loudness, name=artist, line={'color':colors[i]}, opacity=.5), row=1,col=3)
        #speechiness
        fig.add_trace(go.Box(y=artist_features.speechiness, name=artist, line={'color':colors[i]}, opacity=.5), row=2,col=1)
        #acousticness
        fig.add_trace(go.Box(y=artist_features.acousticness, name=artist, line={'color':colors[i]}, opacity=.5), row=2,col=2)
        #instrumentalness
        fig.add_trace(go.Box(y=artist_features.instrumentalness, name=artist, line={'color':colors[i]}, opacity=.5), row=2,col=3)
        #liveness
        fig.add_trace(go.Box(y=artist_features.liveness, name=artist, line={'color':colors[i]}, opacity=.5), row=3,col=1)
        #valence
        fig.add_trace(go.Box(y=artist_features.valence, name=artist, line={'color':colors[i]}, opacity=.5), row=3,col=2)
        #tempo
        fig.add_trace(go.Box(y=artist_features.tempo, name=artist, line={'color':colors[i], 'width': 2}, opacity=.5), row=3,col=3)
